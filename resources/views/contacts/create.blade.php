                                    ...
                                    <div class="-m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <label for="r_male" class="leading-7 text-sm text-gray-600">男性 <input type="radio" id="r_male" name="gender" value='0' {{ old('gender') == 0 ? 'checked' : ''; }}></label>
                                                <label for="r_female" class="leading-7 text-sm text-gray-600">女性 <input type="radio" id="r_female" name="gender" value='1' {{ old('gender') == 1 ? 'checked' : ''; }}></label>
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <div class="relative">
